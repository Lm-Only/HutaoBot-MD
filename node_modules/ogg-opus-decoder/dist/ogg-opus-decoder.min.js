...
gUng= !þ+µèm	M½Êê½½²¦é%0Yg~´p5.\Ø®z y9%ÔiÜ!ÙcÝÅ¦H>ÓXÿZR[¬&ønÇlÓ_:ïi«ñ<ø"QÚ©yz®ªOL¥ÎêÌÝi?Ê'/Ne»:2NÅÝ_òspüR	Oø!!ù+##üÓkéªX-fpdq[U*]@ ö¨5ÍpÖY hÜÂª= ÛN3{ü® À)¡9þ-1® ÂcBNö÷0+È6òÒÑ;lÅ^_>ÓÛQ&jðMIì¤³àlS×jÎ¢@ÈåÕ¢­on=M°©xÉûÖäav=MM©²öÖ¹?{ÃßîøyÛ= 0òûÏ4grèNÒíÏqëðð-êö¸á¥$¨Q.Ò4ä¿V$N_Ý><´æë[â²F#T1É'utÿZXÁ(oàx¡Jo"­öùSæ÷ÒUFÓs* U¡ÓºUµøGáL¨÷©ASjÕ®'!L¢ÕvC¿m·Gâ¼N¹³OÃã§1T:ê¹\Z£ËZæ.î}ª°O'ãÃ ¾I;ûÁHÃä&ÃÐÐK@3EÅÓÉ>½e@ã/òi¡|ÃE³{ñSCmÎëöÁÐÐ%Ó>d''¶9Á/T.N?äª	æÿÀÐÐ%Ó¶öÂ¾ì¦)ÃÕ÷×"e|ÃþBåýrv¶K6öuâÐÌRÎËýæ×%I­OIø¦Ä(HTJ~),ÕDCWWÃö(VwV=M§TsLP³ þV'tT#¡ZLêé;ßù[`});var p={a:M};this.setModule=s=>{t.setModule(i,s)},this.getModule=()=>t.getModule(i),this.instantiate=()=>(this.getModule().then(t=>WebAssembly.instantiate(t,p)).then(t=>{const i=t.exports;var n;(t=>{c=t.i,l=t.j,u=t.k,d=t.l,H=t.m,f=t.o})(i),n=(e=i.g).buffer,new Int8Array(n),new Int16Array(n),s=new Uint8Array(n),new Uint16Array(n),new Int32Array(n),new Uint32Array(n),new Float32Array(n),new Float64Array(n),new BigInt64Array(n),new BigUint64Array(n),(t=>{t.h()})(i),r()}),this.ready=new Promise(t=>{r=t}).then(()=>{this.HEAP=e.buffer,this.malloc=l,this.free=H,this.opus_frame_decoder_create=c,this.opus_frame_decode_float_deinterleaved=u,this.opus_frame_decoder_destroy=d}),this)}function s(e={}){s.errors||Object.defineProperties(s,{errors:{value:new Map([[-1,"OPUS_BAD_ARG: One or more invalid/out of range arguments"],[-2,"OPUS_BUFFER_TOO_SMALL: Not enough bytes allocated in the buffer"],[-3,"OPUS_INTERNAL_ERROR: An internal error was detected"],[-4,"OPUS_INVALID_PACKET: The compressed data passed is corrupted"],[-5,"OPUS_UNIMPLEMENTED: Invalid/unsupported request number"],[-6,"OPUS_INVALID_STATE: An encoder or decoder structure is invalid or already freed"],[-7,"OPUS_ALLOC_FAIL: Memory allocation has failed"]])}}),this.I=()=>new this.P(this).instantiate(this.v,this.J).then(t=>{this.S=t,this.O=0,this.F=0,this.K=0,this.T=this.S.allocateTypedArray(this.W,Uint8Array),this.C=this.S.allocateTypedArray(this._*this.U,Float32Array);const i=this.S.allocateTypedArray(this.V,Uint8Array);i.buf.set(this.D),this.L=this.S.wasm.opus_frame_decoder_create(this.$,this.V,this.R,this.k,i.ptr,this.N,this.G)}),Object.defineProperty(this,"ready",{enumerable:!0,get:()=>this.q}),this.reset=()=>(this.free(),this.I()),this.free=()=>{this.S.free(),this.S.wasm.opus_frame_decoder_destroy(this.L),this.S.wasm.free(this.L)},this.B=t=>{if(!(t instanceof Uint8Array))throw Error("Data to decode must be Uint8Array. Instead got "+typeof t);this.T.buf.set(t);let i,e=this.S.wasm.opus_frame_decode_float_deinterleaved(this.L,this.T.ptr,t.length,this.C.ptr);return e<0&&(i="libopus "+e+" "+(s.errors.get(e)||"Unknown Error"),console.error(i),e=0),{outputBuffer:this.S.getOutputChannels(this.C.buf,this._,e),samplesDecoded:e,error:i}},this.decodeFrame=t=>{let i=[];const s=this.B(t);return s.error&&this.S.addError(i,s.error,t.length,this.K,this.O,this.F),this.K++,this.O+=t.length,this.F+=s.samplesDecoded,this.P.getDecodedAudioMultiChannel(i,[s.outputBuffer],this._,s.samplesDecoded,this.$)},this.decodeFrames=t=>{let i=[],s=[],e=0,r=0;for(;r<t.length;){const n=t[r++],h=this.B(n);i.push(h.outputBuffer),e+=h.samplesDecoded,h.error&&this.S.addError(s,h.error,n.length,this.K,this.O,this.F),this.K++,this.O+=n.length,this.F+=h.samplesDecoded}return this.P.getDecodedAudioMultiChannel(s,i,this._,e,this.$)},this.X=s.isWebWorker,this.P=s.WASMAudioDecoderCommon||t.A,this.v=s.EmscriptenWASM||i,this.J=s.module;const r=t=>"number"==typeof t,n=e.sampleRate,h=e.channels,o=e.streamCount,a=e.coupledStreamCount,c=e.channelMappingTable,l=e.preSkip,u=e.forceStereo?1:0;if(h>2&&(!r(o)||!r(a)||!Array.isArray(c)))throw Error("Invalid Opus Decoder Options for multichannel decoding.");return this.$=[8e3,12e3,16e3,24e3,48e3].includes(n)?n:48e3,this.V=r(h)?h:2,this.R=r(o)?o:1,this.k=r(a)?a:this.V-1,this.D=c||(2===this.V?[0,1]:[0]),this.N=l||0,this.G=h<=8&&2!=h?u:0,this.W=3840*this.V,this.U=5760,this._=this.G?2:this.V,this.q=this.I(),this}var e=r(374);class h extends e.A{constructor(t){super(t,"opus-decoder",s,i)}async decodeFrame(t){return this.postToDecoder("decodeFrame",t)}async decodeFrames(t){return this.postToDecoder("decodeFrames",t)}}const o=Symbol,a=(()=>{const t="left",i="center",s="right";return["","front ","side ","rear "].map(e=>[[t,s],[t,s,i],[t,i,s],[i,t,s],[i]].flatMap(t=>t.map(t=>e+t).join(", ")))})(),c="LFE",l="monophonic (mono)",u="stereo",d="surround",H=(t,...i)=>`${[l,u,"linear "+d,"quadraphonic","5.0 "+d,"5.1 "+d,"6.1 "+d,"7.1 "+d][t-1]} (${i.join(", ")})`,f=[l,H(2,a[0][0]),H(3,a[0][2]),H(4,a[1][0],a[3][0]),H(5,a[1][2],a[3][0]),H(6,a[1][2],a[3][0],c),H(7,a[1][2],a[2][0],a[3][4],c),H(8,a[1][2],a[2][0],a[3][0],c)],M=48e3,p=44100,y=32e3,g=24e3,m=22050,w=16e3,I=8e3,b="absoluteGranulePosition",P="bandwidth",v="bitDepth",A="bitrate",J=A+"Maximum",S=A+"Minimum",O=A+"Nominal",F="buffer",K=F+"Fullness",T="codec",W=T+"Frames",C="coupledStreamCount",_="crc",U=_+"16",V=_+"32",E="data",D="description",L="duration",$="emphasis",R="hasOpusPadding",k="header",Q="isContinuedPacket",N="isCopyrighted",x="isFirstPage",G="isHome",j="isLastPage",q="isOriginal",B="isPrivate",z="isVbr",X="layer",Y="length",Z="mode",tt=Z+"Extension",it="mpeg",st=it+"Version",et="numberAACFrames",rt="outputGain",nt="preSkip",ht="profile",ot=o(),at="protection",ct="segments",lt="subarray",ut="version",dt="vorbis",Ht=dt+"Comments",ft=dt+"Setup",Mt="block",pt=Mt+"ingStrategy",yt=o(),gt=Mt+"Size",mt=Mt+"size0",wt=Mt+"size1",It=o(),bt="channel",Pt=bt+"MappingFamily",vt=bt+"MappingTable",At=bt+"Mode",Jt=o(),St=bt+"s",Ot="copyright",Ft=Ot+"Id",Kt=Ot+"IdStart",Tt="frame",Wt=Tt+"Count",Ct=Tt+"Length",_t="Number",Ut=Tt+_t,Vt=Tt+"Padding",Et=Tt+"Size",Dt="Rate",Lt="inputSample"+Dt,$t="page",Rt=$t+"Checksum",kt=o(),Qt=$t+"SegmentTable",Nt=$t+"Sequence"+_t,xt="sample",Gt=xt+_t,jt=xt+Dt,qt=o(),Bt=xt+"s",zt="stream",Xt=zt+"Count",Yt=zt+"Info",Zt=zt+"Serial"+_t,ti=zt+"StructureVersion",ii="total",si=ii+"BytesOut",ei=ii+"Duration",ri=ii+"Samples",ni=o(),hi=o(),oi=o(),ai=o(),ci=o(),li=o(),ui=o(),di=o(),Hi=o(),fi=o(),Mi=o(),pi=o(),yi=o(),gi=o(),mi=o(),wi=o(),Ii=o(),bi=o(),Pi=Uint8Array,vi=DataView,Ai="reserved",Ji="bad",Si="free",Oi="none",Fi="16bit CRC",Ki=(t,i,s)=>{for(let e=0;e<t[Y];e++){let r=i(e);for(let t=8;t>0;t--)r=s(r);t[e]=r}return t},Ti=Ki(new Pi(256),t=>t,t=>128&t?7^t<<1:t<<1),Wi=[Ki(new Uint16Array(256),t=>t<<8,t=>t<<1^(32768&t?32773:0))],Ci=[Ki(new Uint32Array(256),t=>t,t=>t>>>1^3988292384*(1&t))];for(let r=0;r<15;r++){Wi.push(new Uint16Array(256)),Ci.push(new Uint32Array(256));for(let t=0;t<=255;t++)Wi[r+1][t]=Wi[0][Wi[r][t]>>>8]^Wi[r][t]<<8,Ci[r+1][t]=Ci[r][t]>>>8^Ci[0][255&Ci[r][t]]}const _i=t=>{const i=t[Y],s=i-16;let e=0,r=0;for(;r<=s;)e=Ci[15][255&(t[r++]^e)]^Ci[14][255&(t[r++]^e>>>8)]^Ci[13][255&(t[r++]^e>>>16)]^Ci[12][t[r++]^e>>>24]^Ci[11][t[r++]]^Ci[10][t[r++]]^Ci[9][t[r++]]^Ci[8][t[r++]]^Ci[7][t[r++]]^Ci[6][t[r++]]^Ci[5][t[r++]]^Ci[4][t[r++]]^Ci[3][t[r++]]^Ci[2][t[r++]]^Ci[1][t[r++]]^Ci[0][t[r++]];for(;r!==i;)e=Ci[0][255&(e^t[r++])]^e>>>8;return-1^e},Ui=(...t)=>{const i=new Pi(t.reduce((t,i)=>t+i[Y],0));return t.reduce((t,s)=>(i.set(s,t),t+s[Y]),0),i},Vi=t=>String.fromCharCode(...t),Ei=[0,8,4,12,2,10,6,14,1,9,5,13,3,11,7,15],Di=t=>Ei[15&t]<<4|Ei[t>>4];class Li{constructor(t){this.Y=t,this.Z=8*t[Y]}set position(t){this.Z=t}get position(){return this.Z}read(t){const i=Math.floor(this.Z/8),s=this.Z%8;return this.Z-=t,(Di(this.Y[i-1])<<8)+Di(this.Y[i])>>7-s&255}}class $i{constructor(t,i){this.tt=t,this.it=i,this[mi]()}[wi](){this.st=!0}[mi](){this.et=new Map,this.rt=new WeakMap,this.nt=!1,this.ht=!1,this.ot=null,this.st=!1}[gi](t,i){if(this.it){this.ot!==t&&(this.ot=t,this.ht=!0);const s=this.rt.get(this.et.get(this.ct));this.ht&&s&&this.it({bitrate:t,...s},i),this.ht=!1}}[Hi](t){const i=this.et.get(t);return i&&this.lt(t),i}[fi](t,i,s){this.st&&(this.nt||(this.tt({...i}),this.nt=!0),this.lt(t),this.et.set(t,i),this.rt.set(i,s))}lt(t){this.it&&t!==this.ct&&(this.ht=!0,this.ct=t)}}const Ri=new WeakMap,ki=new WeakMap;class Qi{constructor(t,i){this.ut=t,this.et=i}*[ui](){let t;for(;;){if(t=yield*this.Frame[Mi](this.ut,this.et,0),t)return t;this.ut[hi](1)}}*[di](t){let i=yield*this[ui]();const s=ki.get(i)[Y];if(t||this.ut.dt||(yield*this.Header[Hi](this.ut,this.et,s)))return this.et[wi](),this.ut[hi](s),this.ut[ai](i),i;this.ut[ci](`Missing ${Tt} at ${s} bytes from current position.`,`Dropping current ${Tt} and trying again.`),this.et[mi](),this.ut[hi](1)}}class Ni{constructor(t,i){ki.set(this,{[k]:t}),this[E]=i}}class xi extends Ni{static*[Mi](t,i,s,e,r){const n=yield*t[Hi](s,e,r);if(n){const t=Ri.get(n)[Ct],e=Ri.get(n)[Bt];return new i(n,(yield*s[ni](t,r))[lt](0,t),e)}return null}constructor(t,i,s){super(t,i),this[k]=t,this[Bt]=s,this[L]=s/t[jt]*1e3,this[Ut]=null,this[si]=null,this[ri]=null,this[ei]=null,ki.get(this)[Y]=i[Y]}}const Gi="unsynchronizationFlag",ji="extendedHeaderFlag",qi="experimentalFlag",Bi="footerPresent";class zi{static*getID3v2Header(t,i,s){const e={};let r=yield*t[ni](3,s);if(73!==r[0]||68!==r[1]||51!==r[2])return null;if(r=yield*t[ni](10,s),e[ut]=`id3v2.${r[3]}.${r[4]}`,15&r[5])return null;if(e[Gi]=!!(128&r[5]),e[ji]=!!(64&r[5]),e[qi]=!!(32&r[5]),e[Bi]=!!(16&r[5]),128&r[6]||128&r[7]||128&r[8]||128&r[9])return null;const n=r[6]<<21|r[7]<<14|r[8]<<7|r[9];return e[Y]=10+n,new zi(e)}constructor(t){this[ut]=t[ut],this[Gi]=t[Gi],this[ji]=t[ji],this[qi]=t[qi],this[Bi]=t[Bi],this[Y]=t[Y]}}class Xi{constructor(t){Ri.set(this,t),this[v]=t[v],this[A]=null,this[St]=t[St],this[At]=t[At],this[jt]=t[jt]}}const Yi={0:[Si,Si,Si,Si,Si],16:[32,32,32,32,8],240:[Ji,Ji,Ji,Ji,Ji]},Zi=(t,i,s)=>8*((t+s)%i+i)*(1<<(t+s)/i)-8*i*(i/8|0);for(let r=2;r<15;r++)Yi[r<<4]=[32*r,Zi(r,4,0),Zi(r,4,-1),Zi(r,8,4),Zi(r,8,0)];const ts="bands ",is=" to 31",ss={0:ts+4+is,16:ts+8+is,32:ts+12+is,48:ts+16+is},es="bitrateIndex",rs="v2",ns="v1",hs="Intensity stereo ",os=", MS stereo ",as="on",cs="off",ls={0:hs+cs+os+cs,16:hs+as+os+cs,32:hs+cs+os+as,48:hs+as+os+as},us={0:{[D]:Ai},2:{[D]:"Layer III",[Vt]:1,[tt]:ls,[ns]:{[es]:2,[Bt]:1152},[rs]:{[es]:4,[Bt]:576}},4:{[D]:"Layer II",[Vt]:1,[tt]:ss,[Bt]:1152,[ns]:{[es]:1},[rs]:{[es]:4}},6:{[D]:"Layer I",[Vt]:4,[tt]:ss,[Bt]:384,[ns]:{[es]:0},[rs]:{[es]:3}}},ds="MPEG Version ",Hs="ISO/IEC ",fs={0:{[D]:ds+"2.5 (later extension of MPEG 2)",[X]:rs,[jt]:{0:11025,4:12e3,8:I,12:Ai}},8:{[D]:Ai},16:{[D]:`${ds}2 (${Hs}13818-3)`,[X]:rs,[jt]:{0:m,4:g,8:w,12:Ai}},24:{[D]:`${ds}1 (${Hs}11172-3)`,[X]:ns,[jt]:{0:p,4:M,8:y,12:Ai}},length:Y},Ms={0:Fi,1:Oi},ps={0:Oi,1:"50/15 ms",2:Ai,3:"CCIT J.17"},ys={0:{[St]:2,[D]:u},64:{[St]:2,[D]:"joint "+u},128:{[St]:2,[D]:"dual channel"},192:{[St]:1,[D]:l}};class gs extends Xi{static*[Hi](t,i,s){const e={},r=yield*zi.getID3v2Header(t,i,s);r&&(yield*t[ni](r[Y],s),t[hi](r[Y]));const n=yield*t[ni](4,s),h=Vi(n[lt](0,4)),o=i[Hi](h);if(o)return new gs(o);if(255!==n[0]||n[1]<224)return null;const a=fs[24&n[1]];if(a[D]===Ai)return null;const c=6&n[1];if(us[c][D]===Ai)return null;const l={...us[c],...us[c][a[X]]};if(e[st]=a[D],e[X]=l[D],e[Bt]=l[Bt],e[at]=Ms[1&n[1]],e[Y]=4,e[A]=Yi[240&n[2]][l[es]],e[A]===Ji)return null;if(e[jt]=a[jt][12&n[2]],e[jt]===Ai)return null;if(e[Vt]=2&n[2]&&l[Vt],e[B]=!!(1&n[2]),e[Ct]=Math.floor(125*e[A]*e[Bt]/e[jt]+e[Vt]),!e[Ct])return null;const u=192&n[3];if(e[At]=ys[u][D],e[St]=ys[u][St],e[tt]=l[tt][48&n[3]],e[N]=!!(8&n[3]),e[q]=!!(4&n[3]),e[$]=ps[3&n[3]],e[$]===Ai)return null;e[v]=16;{const{length:t,frameLength:s,samples:r,...n}=e;i[fi](h,e,n)}return new gs(e)}constructor(t){super(t),this[A]=t[A],this[$]=t[$],this[Vt]=t[Vt],this[N]=t[N],this[q]=t[q],this[B]=t[B],this[X]=t[X],this[tt]=t[tt],this[st]=t[st],this[at]=t[at]}}class ms extends xi{static*[Mi](t,i,s){return yield*super[Mi](gs,ms,t,i,s)}constructor(t,i,s){super(t,i,s)}}class ws extends Qi{constructor(t,i,s){super(t,i),this.Frame=ms,this.Header=gs,s(this[T])}get[T](){return it}*[pi](){return yield*this[di]()}}const Is={0:"MPEG-4",8:"MPEG-2"},bs={0:"valid",2:Ji,4:Ji,6:Ji},Ps={0:Fi,1:Oi},vs={0:"AAC Main",64:"AAC LC (Low Complexity)",128:"AAC SSR (Scalable Sample Rate)",192:"AAC LTP (Long Term Prediction)"},As={0:96e3,4:88200,8:64e3,12:M,16:p,20:y,24:g,28:m,32:w,36:12e3,40:11025,44:I,48:7350,52:Ai,56:Ai,60:"frequency is written explicitly"},Js={0:{[St]:0,[D]:"Defined in AOT Specific Config"},64:{[St]:1,[D]:l},128:{[St]:2,[D]:H(2,a[0][0])},192:{[St]:3,[D]:H(3,a[1][3])},256:{[St]:4,[D]:H(4,a[1][3],a[3][4])},320:{[St]:5,[D]:H(5,a[1][3],a[3][0])},384:{[St]:6,[D]:H(6,a[1][3],a[3][0],c)},448:{[St]:8,[D]:H(8,a[1][3],a[2][0],a[3][0],c)}};class Ss extends Xi{static*[Hi](t,i,s){const e={},r=yield*t[ni](7,s),n=Vi([r[0],r[1],r[2],252&r[3]|3&r[6]]),h=i[Hi](n);if(h)Object.assign(e,h);else{if(255!==r[0]||r[1]<240)return null;if(e[st]=Is[8&r[1]],e[X]=bs[6&r[1]],e[X]===Ji)return null;const t=1&r[1];e[at]=Ps[t],e[Y]=t?7:9,e[ot]=192&r[2],e[qt]=60&r[2];const s=2&r[2];if(e[ht]=vs[e[ot]],e[jt]=As[e[qt]],e[jt]===Ai)return null;e[B]=!!s,e[Jt]=448&(r[2]<<8|r[3]),e[At]=Js[e[Jt]][D],e[St]=Js[e[Jt]][St],e[q]=!!(32&r[3]),e[G]=!!(8&r[3]),e[Ft]=!!(8&r[3]),e[Kt]=!!(4&r[3]),e[v]=16,e[Bt]=1024,e[et]=3&r[6];{const{length:t,channelModeBits:s,profileBits:r,sampleRateBits:h,frameLength:o,samples:a,numberAACFrames:c,...l}=e;i[fi](n,e,l)}}if(e[Ct]=8191&(r[3]<<11|r[4]<<3|r[5]>>5),!e[Ct])return null;const o=2047&(r[5]<<6|r[6]>>2);return e[K]=2047===o?"VBR":o,new Ss(e)}constructor(t){super(t),this[Ft]=t[Ft],this[Kt]=t[Kt],this[K]=t[K],this[G]=t[G],this[q]=t[q],this[B]=t[B],this[X]=t[X],this[Y]=t[Y],this[st]=t[st],this[et]=t[et],this[ht]=t[ht],this[at]=t[at]}get audioSpecificConfig(){const t=Ri.get(this),i=t[ot]+64<<5|t[qt]<<5|t[Jt]>>3,s=new Pi(2);return new vi(s[F]).setUint16(0,i,!1),s}}class Os extends xi{static*[Mi](t,i,s){return yield*super[Mi](Ss,Os,t,i,s)}constructor(t,i,s){super(t,i,s)}}class Fs extends Qi{constructor(t,i,s){super(t,i),this.Frame=Os,this.Header=Ss,s(this[T])}get[T](){return"aac"}*[pi](){return yield*this[di]()}}class Ks extends xi{static Ht(t){return(t[t[Y]-2]<<8)+t[t[Y]-1]}static[bi](t){const i=Ks.Ht(t),s=(t=>{const i=t[Y],s=i-16;let e=0,r=0;for(;r<=s;)e^=t[r++]<<8|t[r++],e=Wi[15][e>>8]^Wi[14][255&e]^Wi[13][t[r++]]^Wi[12][t[r++]]^Wi[11][t[r++]]^Wi[10][t[r++]]^Wi[9][t[r++]]^Wi[8][t[r++]]^Wi[7][t[r++]]^Wi[6][t[r++]]^Wi[5][t[r++]]^Wi[4][t[r++]]^Wi[3][t[r++]]^Wi[2][t[r++]]^Wi[1][t[r++]]^Wi[0][t[r++]];for(;r!==i;)e=(255&e)<<8^Wi[0][e>>8^t[r++]];return e})(t[lt](0,-2));return i===s}constructor(t,i,s){i[Yt]=s,i[U]=Ks.Ht(t),super(i,t,Ri.get(i)[Bt])}}const Ts="get from STREAMINFO metadata block",Ws={0:"Fixed",1:"Variable"},Cs={0:Ai,16:192};for(let r=2;r<16;r++)Cs[r<<4]=r<6?576*2**(r-2):2**r;const _s={0:Ts,1:88200,2:176400,3:192e3,4:I,5:w,6:m,7:g,8:y,9:p,10:M,11:96e3,15:Ji},Us={0:{[St]:1,[D]:l},16:{[St]:2,[D]:H(2,a[0][0])},32:{[St]:3,[D]:H(3,a[0][1])},48:{[St]:4,[D]:H(4,a[1][0],a[3][0])},64:{[St]:5,[D]:H(5,a[1][1],a[3][0])},80:{[St]:6,[D]:H(6,a[1][1],c,a[3][0])},96:{[St]:7,[D]:H(7,a[1][1],c,a[3][4],a[2][0])},112:{[St]:8,[D]:H(8,a[1][1],c,a[3][0],a[2][0])},128:{[St]:2,[D]:u+" (left, diff)"},144:{[St]:2,[D]:u+" (diff, right)"},160:{[St]:2,[D]:u+" (avg, diff)"},176:Ai,192:Ai,208:Ai,224:Ai,240:Ai},Vs={0:Ts,2:8,4:12,6:Ai,8:16,10:20,12:24,14:Ai};class Es extends Xi{static ft(t){if(t[0]>254)return null;if(t[0]<128)return{value:t[0],length:1};let i=1;for(let n=64;n&t[0];n>>=1)i++;let s=i-1,e=0,r=0;for(;s>0;r+=6,s--){if(128!=(192&t[s]))return null;e|=(63&t[s])<<r}return e|=(t[s]&127>>i)<<r,{value:e,length:i}}static[Ii](t,i){const s={*[ni](){return t}};return Es[Hi](s,i,0).next().value}static*[Hi](t,i,s){let e=yield*t[ni](6,s);if(255!==e[0]||248!==e[1]&&249!==e[1])return null;const r={},n=Vi(e[lt](0,4)),h=i[Hi](n);if(h)Object.assign(r,h);else{if(r[yt]=1&e[1],r[pt]=Ws[r[yt]],r[It]=240&e[2],r[qt]=15&e[2],r[gt]=Cs[r[It]],r[gt]===Ai)return null;if(r[jt]=_s[r[qt]],r[jt]===Ji)return null;if(1&e[3])return null;const t=Us[240&e[3]];if(t===Ai)return null;if(r[St]=t[St],r[At]=t[D],r[v]=Vs[14&e[3]],r[v]===Ai)return null}r[Y]=5,e=yield*t[ni](r[Y]+8,s);const o=Es.ft(e[lt](4));if(!o)return null;if(r[yt]?r[Gt]=o.value:r[Ut]=o.value,r[Y]+=o[Y],96===r[It]?(e[Y]<r[Y]&&(e=yield*t[ni](r[Y],s)),r[gt]=e[r[Y]-1]+1,r[Y]+=1):112===r[It]&&(e[Y]<r[Y]&&(e=yield*t[ni](r[Y],s)),r[gt]=(e[r[Y]-1]<<8)+e[r[Y]]+1,r[Y]+=2),r[Bt]=r[gt],12===r[qt]?(e[Y]<r[Y]&&(e=yield*t[ni](r[Y],s)),r[jt]=1e3*e[r[Y]-1],r[Y]+=1):13===r[qt]?(e[Y]<r[Y]&&(e=yield*t[ni](r[Y],s)),r[jt]=(e[r[Y]-1]<<8)+e[r[Y]],r[Y]+=2):14===r[qt]&&(e[Y]<r[Y]&&(e=yield*t[ni](r[Y],s)),r[jt]=10*((e[r[Y]-1]<<8)+e[r[Y]]),r[Y]+=2),e[Y]<r[Y]&&(e=yield*t[ni](r[Y],s)),r[_]=e[r[Y]-1],r[_]!==(t=>{let i=0;const s=t[Y];for(let e=0;e!==s;e++)i=Ti[i^t[e]];return i})(e[lt](0,r[Y]-1)))return null;if(!h){const{blockingStrategyBits:t,frameNumber:s,sampleNumber:e,samples:h,sampleRateBits:o,blockSizeBits:a,crc:c,length:l,...u}=r;i[fi](n,r,u)}return new Es(r)}constructor(t){super(t),this[U]=null,this[pt]=t[pt],this[gt]=t[gt],this[Ut]=t[Ut],this[Gt]=t[Gt],this[Yt]=null}}class Ds extends Qi{constructor(t,i,s){super(t,i),this.Frame=Ks,this.Header=Es,s(this[T])}get[T](){return"flac"}*Mt(t){const i=yield*this.ut[ni](2,0),s=i[Y]-2;for(;t<s;){if(255===i[t]){const s=i[t+1];if(248===s||249===s)break;255!==s&&t++}t++}return t}*[pi](){for(;;){const t=yield*Es[Hi](this.ut,this.et,0);if(t){let i=Ri.get(t)[Y]+2;for(;i<=524288;){if(this.ut.dt||(yield*Es[Hi](this.ut,this.et,i))){let s=yield*this.ut[ni](i);if(this.ut.dt||(s=s[lt](0,i)),Ks[bi](s)){const e=new Ks(s,t);return this.et[wi](),this.ut[hi](i),this.ut[ai](e),e}}i=yield*this.Mt(i+1)}this.ut[ci](`Unable to sync FLAC frame after searching ${i} bytes.`),this.ut[hi](i)}else this.ut[hi](yield*this.Mt(1))}}[yi](t){return 0===t[Nt]?(this.et[wi](),this.yt=t[E][lt](13)):1===t[Nt]||(t[W]=ki.get(t)[ct].map(t=>{const i=Es[Ii](t,this.et);if(i)return new Ks(t,i,this.yt);this.ut[ci]("Failed to parse Ogg FLAC frame","Skipping invalid FLAC frame")}).filter(t=>!!t)),t}}class Ls{static*[Hi](t,i,s){const e={};let r=yield*t[ni](28,s);if(79!==r[0]||103!==r[1]||103!==r[2]||83!==r[3])return null;if(e[ti]=r[4],248&r[5])return null;e[j]=!!(4&r[5]),e[x]=!!(2&r[5]),e[Q]=!!(1&r[5]);const n=new vi(Pi.from(r[lt](0,28))[F]);e[b]=(t=>{try{return t.getBigInt64(6,!0)}catch{const i=128&t.getUint8(13)?-1:1;let s=t.getUint32(6,!0),e=t.getUint32(10,!0);return-1===i&&(s=1+~s,e=1+~e),e>1048575&&console.warn("This platform does not support BigInt"),i*(s+e*2**32)}})(n),e[Zt]=n.getInt32(14,!0),e[Nt]=n.getInt32(18,!0),e[Rt]=n.getInt32(22,!0);const h=r[26];e[Y]=h+27,r=yield*t[ni](e[Y],s),e[Ct]=0,e[Qt]=[],e[kt]=Pi.from(r[lt](27,e[Y]));for(let o=0,a=0;o<h;o++){const t=e[kt][o];e[Ct]+=t,a+=t,255===t&&o!==h-1||(e[Qt].push(a),a=0)}return new Ls(e)}constructor(t){Ri.set(this,t),this[b]=t[b],this[Q]=t[Q],this[x]=t[x],this[j]=t[j],this[Qt]=t[Qt],this[Nt]=t[Nt],this[Rt]=t[Rt],this[Zt]=t[Zt]}}class $s extends Ni{static*[Mi](t,i,s){const e=yield*Ls[Hi](t,i,s);if(e){const i=Ri.get(e)[Ct],s=Ri.get(e)[Y],r=s+i,n=(yield*t[ni](r,0))[lt](0,r),h=n[lt](s,r);return new $s(e,h,n)}return null}constructor(t,i,s){super(t,i),ki.get(this)[Y]=s[Y],this[W]=[],this.rawData=s,this[b]=t[b],this[V]=t[Rt],this[L]=0,this[Q]=t[Q],this[x]=t[x],this[j]=t[j],this[Nt]=t[Nt],this[Bt]=0,this[Zt]=t[Zt]}}class Rs extends xi{constructor(t,i,s){super(i,t,s)}}const ks={0:f.slice(0,2),1:f},Qs="SILK-only",Ns="CELT-only",xs="Hybrid",Gs="narrowband",js="medium-band",qs="wideband",Bs="super-wideband",zs="fullband",Xs={0:{[Z]:Qs,[P]:Gs,[Et]:10},8:{[Z]:Qs,[P]:Gs,[Et]:20},16:{[Z]:Qs,[P]:Gs,[Et]:40},24:{[Z]:Qs,[P]:Gs,[Et]:60},32:{[Z]:Qs,[P]:js,[Et]:10},40:{[Z]:Qs,[P]:js,[Et]:20},48:{[Z]:Qs,[P]:js,[Et]:40},56:{[Z]:Qs,[P]:js,[Et]:60},64:{[Z]:Qs,[P]:qs,[Et]:10},72:{[Z]:Qs,[P]:qs,[Et]:20},80:{[Z]:Qs,[P]:qs,[Et]:40},88:{[Z]:Qs,[P]:qs,[Et]:60},96:{[Z]:xs,[P]:Bs,[Et]:10},104:{[Z]:xs,[P]:Bs,[Et]:20},112:{[Z]:xs,[P]:zs,[Et]:10},120:{[Z]:xs,[P]:zs,[Et]:20},128:{[Z]:Ns,[P]:Gs,[Et]:2.5},136:{[Z]:Ns,[P]:Gs,[Et]:5},144:{[Z]:Ns,[P]:Gs,[Et]:10},152:{[Z]:Ns,[P]:Gs,[Et]:20},160:{[Z]:Ns,[P]:qs,[Et]:2.5},168:{[Z]:Ns,[P]:qs,[Et]:5},176:{[Z]:Ns,[P]:qs,[Et]:10},184:{[Z]:Ns,[P]:qs,[Et]:20},192:{[Z]:Ns,[P]:Bs,[Et]:2.5},200:{[Z]:Ns,[P]:Bs,[Et]:5},208:{[Z]:Ns,[P]:Bs,[Et]:10},216:{[Z]:Ns,[P]:Bs,[Et]:20},224:{[Z]:Ns,[P]:zs,[Et]:2.5},232:{[Z]:Ns,[P]:zs,[Et]:5},240:{[Z]:Ns,[P]:zs,[Et]:10},248:{[Z]:Ns,[P]:zs,[Et]:20}};class Ys extends Xi{static[Ii](t,i,s){const e={};if(e[St]=t[9],e[Pt]=t[18],e[Y]=0!==e[Pt]?21+e[St]:19,t[Y]<e[Y])throw Error("Out of data while inside an Ogg Page");const r=3&i[0],n=3===r?2:1,h=Vi(t[lt](0,e[Y]))+Vi(i[lt](0,n)),o=s[Hi](h);if(o)return new Ys(o);if("OpusHead"!==h.substr(0,8))return null;if(1!==t[8])return null;e[E]=Pi.from(t[lt](0,e[Y]));const a=new vi(e[E][F]);if(e[v]=16,e[nt]=a.getUint16(10,!0),e[Lt]=a.getUint32(12,!0),e[jt]=M,e[rt]=a.getInt16(16,!0),e[Pt]in ks&&(e[At]=ks[e[Pt]][e[St]-1],!e[At]))return null;0!==e[Pt]&&(e[Xt]=t[19],e[C]=t[20],e[vt]=[...t[lt](21,e[St]+21)]);const c=Xs[248&i[0]];switch(e[Z]=c[Z],e[P]=c[P],e[Et]=c[Et],r){case 0:e[Wt]=1;break;case 1:case 2:e[Wt]=2;break;case 3:e[z]=!!(128&i[1]),e[R]=!!(64&i[1]),e[Wt]=63&i[1];break;default:return null}{const{length:t,data:i,channelMappingFamily:r,...n}=e;s[fi](h,e,n)}return new Ys(e)}constructor(t){super(t),this[E]=t[E],this[P]=t[P],this[Pt]=t[Pt],this[vt]=t[vt],this[C]=t[C],this[Wt]=t[Wt],this[Et]=t[Et],this[R]=t[R],this[Lt]=t[Lt],this[z]=t[z],this[Z]=t[Z],this[rt]=t[rt],this[nt]=t[nt],this[Xt]=t[Xt]}}class Zs extends Qi{constructor(t,i,s){super(t,i),this.Frame=Rs,this.Header=Ys,s(this[T]),this.gt=null,this.wt=null}get[T](){return"opus"}[yi](t){return 0===t[Nt]?(this.et[wi](),this.gt=t[E]):1===t[Nt]||(t[W]=ki.get(t)[ct].map(t=>{const i=Ys[Ii](this.gt,t,this.et);if(i){null===this.wt&&(this.wt=i[nt]);let s=i[Et]*i[Wt]/1e3*i[jt];return this.wt>0&&(this.wt-=s,s=this.wt<0?-this.wt:0),new Rs(t,i,s)}this.ut[li]("Failed to parse Ogg Opus Header","Not a valid Ogg Opus file")})),t}}class te extends xi{constructor(t,i,s){super(i,t,s)}}const ie={};for(let r=0;r<8;r++)ie[r+6]=2**(6+r);class se extends Xi{static[Ii](t,i,s,e){if(t[Y]<30)throw Error("Out of data while inside an Ogg Page");const r=Vi(t[lt](0,30)),n=i[Hi](r);if(n)return new se(n);const h={[Y]:30};if("vorbis"!==r.substr(0,7))return null;h[E]=Pi.from(t[lt](0,30));const o=new vi(h[E][F]);if(h[ut]=o.getUint32(7,!0),0!==h[ut])return null;if(h[St]=t[11],h[At]=f[h[St]-1]||"application defined",h[jt]=o.getUint32(12,!0),h[J]=o.getInt32(16,!0),h[O]=o.getInt32(20,!0),h[S]=o.getInt32(24,!0),h[wt]=ie[(240&t[28])>>4],h[mt]=ie[15&t[28]],h[mt]>h[wt])return null;if(1!==t[29])return null;h[v]=32,h[ft]=e,h[Ht]=s;{const{length:t,data:s,version:e,vorbisSetup:n,vorbisComments:o,...a}=h;i[fi](r,h,a)}return new se(h)}constructor(t){super(t),this[J]=t[J],this[S]=t[S],this[O]=t[O],this[mt]=t[mt],this[wt]=t[wt],this[E]=t[E],this[Ht]=t[Ht],this[ft]=t[ft]}}class ee extends Qi{constructor(t,i,s){super(t,i),this.Frame=te,s(this[T]),this.gt=null,this.It=!1,this.bt=null}get[T](){return dt}[yi](t){t[W]=[];for(const i of ki.get(t)[ct])if(1===i[0])this.et[wi](),this.gt=t[E],this.It=!1;else if(3===i[0])this.Pt=i;else if(5===i[0])this.vt=i,this.At=this.Jt(i),this.It=!0;else if(this.It){const s=se[Ii](this.gt,this.et,this.Pt,this.vt);s?t[W].push(new te(i,s,this.St(i,s))):this.ut[logError]("Failed to parse Ogg Vorbis Header","Not a valid Ogg Vorbis file")}return t}St(t,i){const s=this.At.blockFlags[t[0]>>1&this.At.mask]?i[wt]:i[mt],e=null===this.bt?0:(this.bt+s)/4;return this.bt=s,e}Jt(t){const i=new Li(t),s={count:0,blockFlags:[]};for(;1&~i.read(1););let e;for(;s.count<64&&i.position>0;){Di(i.read(8));let t=0;for(;0===i.read(8)&&t++<3;);if(4!==t){1+((126&Di(e))>>1)!==s.count&&this.ut[ci]("vorbis derived mode count did not match actual mode count");break}e=i.read(7),s.blockFlags.unshift(1&e),i.position+=6,s.count++}return s.mask=(1<<Math.log2(s.count))-1,s}}class re{constructor(t,i,s){this.ut=t,this.et=i,this.Ot=s,this.Ft=new Pi,this.Kt=null,this.Tt=null,this.Wt=null}get[T](){return this.Kt||""}Ct(t,i){this.Kt!==t&&(this.et[mi](),this._t=new i(this.ut,this.et,this.Ot),this.Kt=t)}Ut({data:t}){const i=Vi(t[lt](0,8));switch(i){case"fishead\0":return!1;case"OpusHead":return this.Ct("opus",Zs),!0;case/^\x7fFLAC/.test(i)&&i:return this.Ct("flac",Ds),!0;case/^\x01vorbis/.test(i)&&i:return this.Ct(dt,ee),!0;default:return!1}}Vt(t){t[Nt]!==this.Et+1&&this.Et>1&&t[Nt]>1&&this.ut[ci]("Unexpected gap in Ogg Page Sequence Number.",`Expected: ${this.Et+1}, Got: ${t[Nt]}`),this.Et=t[Nt]}Dt(t){null===this.Tt&&(this.Et=t[Nt],this.Tt=this.Ut(t)),this.Vt(t);const i=ki.get(t),s=Ri.get(i[k]);let e=0;if(i[ct]=s[Qt].map(i=>t[E][lt](e,e+=i)),this.Ft[Y]&&(i[ct][0]=Ui(this.Ft,i[ct][0]),this.Ft=new Pi),255===s[kt][s[kt][Y]-1]&&(this.Ft=Ui(this.Ft,i[ct].pop())),null!==this.Wt&&(t[Bt]=Number(t[b]-this.Wt)),this.Wt=t[b],this.Tt){const i=this._t[yi](t);return this.ut[ai](i),i}return t}}class ne extends Qi{constructor(t,i,s){super(t,i),this.Ot=s,this.Frame=$s,this.Header=Ls,this.Lt=new Map,this.$t=null}get[T](){const t=this.Lt.get(this.$t);return t?t.codec:""}*[pi](){const t=yield*this[di](!0);this.$t=t[Zt];let i=this.Lt.get(this.$t);return i||(i=new re(this.ut,this.et,this.Ot),this.Lt.set(this.$t,i)),t[j]&&this.Lt.delete(this.$t),i.Dt(t)}}const he=()=>{},oe=class{constructor(t,{onCodec:i,onCodecHeader:s,onCodecUpdate:e,enableLogging:r=!1,enableFrameCRC32:n=!0}={}){this.Rt=t,this.Ot=i||he,this.tt=s||he,this.it=e,this.kt=r,this.Qt=n?_i:he,this[mi]()}get[T](){return this._t?this._t[T]:""}[mi](){this.et=new $i(this.tt,this.it),this.Nt=this.xt(),this.Nt.next()}*flush(){this.dt=!0;for(let t=this.Nt.next();t.value;t=this.Nt.next())yield t.value;this.dt=!1,this[mi]()}*parseChunk(t){for(let i=this.Nt.next(t);i.value;i=this.Nt.next())yield i.value}parseAll(t){return[...this.parseChunk(t),...this.flush()]}*xt(){if(this.Rt.match(/aac/))this._t=new Fs(this,this.et,this.Ot);else if(this.Rt.match(/mpeg/))this._t=new ws(this,this.et,this.Ot);else if(this.Rt.match(/flac/))this._t=new Ds(this,this.et,this.Ot);else{if(!this.Rt.match(/ogg/))throw Error("Unsupported Codec "+mimeType);this._t=new ne(this,this.et,this.Ot)}for(this.K=0,this.Gt=0,this.jt=0,this.qt=0,this.Bt=0,this.$=void 0,this.zt=new Uint8Array(0);;){const t=yield*this._t[pi]();t&&(yield t)}}*[ni](t=0,i=0){let s;for(;this.zt[Y]<=t+i;){if(s=yield,this.dt)return this.zt[lt](i);s&&(this.jt+=s[Y],this.zt=Ui(this.zt,s))}return this.zt[lt](i)}[hi](t){this.Gt+=t,this.zt=this.zt[lt](t)}[oi](t){this.$=t[k][jt],t[k][A]=t[L]>0?8*Math.round(t[E][Y]/t[L]):0,t[Ut]=this.K++,t[si]=this.qt,t[ri]=this.Bt,t[ei]=this.Bt/this.$*1e3,t[V]=this.Qt(t[E]),this.et[gi](t[k][A],t[ei]),this.qt+=t[E][Y],this.Bt+=t[Bt]}[ai](t){if(t[W]){if(t[j]){let i=t[Bt];t[W].forEach(t=>{const s=t[Bt];i<s&&(t[Bt]=i>0?i:0,t[L]=t[Bt]/t[k][jt]*1e3),i-=s,this[oi](t)})}else t[Bt]=0,t[W].forEach(i=>{t[Bt]+=i[Bt],this[oi](i)});t[L]=t[Bt]/this.$*1e3||0,t[ri]=this.Bt,t[ei]=this.Bt/this.$*1e3||0,t[si]=this.qt}else this[oi](t)}Xt(t,i){if(this.kt){const s=[`${T}:         ${this[T]}`,"inputMimeType: "+this.Rt,"readPosition:  "+this.Gt,"totalBytesIn:  "+this.jt,`${si}: ${this.qt}`],e=Math.max(...s.map(t=>t[Y]));i.push("--stats--"+"-".repeat(e-9),...s,"-".repeat(e)),t("codec-parser",i.reduce((t,i)=>t+"\n  "+i,""))}}[ci](...t){this.Xt(console.warn,t)}[li](...t){this.Xt(console.error,t)}},ae=b,ce=W,le=C,ue=E,de=k,He=j,fe=nt,Me=vt,pe=St,ye=Xt,ge=ri;class me{constructor(i={}){this.$=i.sampleRate||48e3,this.Yt=i.speechQualityEnhancement,this.G=void 0!==i.forceStereo&&i.forceStereo,this.Ot=t=>{if("opus"!==t)throw Error("ogg-opus-decoder does not support this codec "+t)},new t.A,this.Zt=["lace","nolace"].includes(this.Yt),this.ti=this.ii(),this.q=this.I()}si(){this.ei=this.Zt?this.OpusMLDecoder:this.OpusDecoder}async ii(){if(this.Zt)if(await(async()=>WebAssembly.validate(new Uint8Array([0,97,115,109,1,0,0,0,1,5,1,96,0,1,123,3,2,1,0,10,10,1,8,0,65,0,253,15,253,98,11])))()){const{OpusMLDecoder:t,OpusMLDecoderWebWorker:i}=await r.e(52).then(r.bind(r,108));this.OpusMLDecoder=t,this.OpusMLDecoderWebWorker=i}else console.warn(`ogg-opus-decoder: This platform does not support WebAssembly SIMD; { speechQualityEnhancements: '${this.Yt}' } has been disabled`),this.Zt=!1;this.OpusDecoder=s,this.OpusDecoderWebWorker=h,this.si()}async I(){this.L&&await this.L.free(),this.L=null,this.ut=new oe("application/ogg",{onCodec:this.Ot,enableFrameCRC32:!1})}async ri(t){return this.ni=0,this.N=t[fe],this.V=this.G?2:t[pe],await this.ti,this.L=new this.ei({channels:t[pe],streamCount:t[ye],coupledStreamCount:t[le],channelMappingTable:t[Me],preSkip:Math.round(this.N/48e3*this.$),sampleRate:this.$,speechQualityEnhancement:this.Yt,forceStereo:this.G}),this.L.ready}get ready(){return this.q}async reset(){this.q=this.I(),await this.q}free(){this.q=this.I()}async B(t){let i=[],s=[],e=[],r=0;const n=async()=>{if(i.length){await this.hi;const{channelData:t,samplesDecoded:n,errors:h}=await this.L.decodeFrames(i);e.push(t),s.push(...h),r+=n,this.ni+=n,i=[]}};for(let h=0;h<t.length;h++){const s=t[h],o=s[ce].map(t=>t[ue]);if(o.length&&(i.push(...o),this.L||(this.hi=this.ri(s[ce][0][de]))),s[He]){if(await n(),void 0!==s[ae]&&e.length){const t=this.ni/this.$*48e3,i=Math.round((t-s[ge])/48e3*this.$),n=e[e.length-1];if(i>0)for(let s=0;s<n.length;s++)n[s]=n[s].subarray(0,n[s].length-i);r-=i,this.ni-=i}await this.reset()}}return await n(),[s,e,this.V,r,this.$,16]}async decode(i){const s=await this.B([...this.ut.parseChunk(i)]);return t.A.getDecodedAudioMultiChannel(...s)}async decodeFile(i){const s=await this.B([...this.ut.parseAll(i)]);return await this.reset(),t.A.getDecodedAudioMultiChannel(...s)}async flush(){const i=await this.B([...this.ut.flush()]);return await this.reset(),t.A.getDecodedAudioMultiChannel(...i)}}class we extends me{constructor(t){super(t)}si(){this.ei=this.Zt?this.OpusMLDecoderWebWorker:this.OpusDecoderWebWorker}async free(){await super.reset()}}var Ie=r(0);(0,Ie.A)(me,"OggOpusDecoder"),(0,Ie.A)(we,"OggOpusDecoderWebWorker")})(),n})(),"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["ogg-opus-decoder"]=t():this["ogg-opus-decoder"]=t();
